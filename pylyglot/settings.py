...
SECRET_KEY = '64e_da9=r7o@lx5+3jk7zeer9u4ap7d2z^uj8#gu**p=o%lv^r'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'core.context_processors.total_packages',
    'core.context_processors.total_languages',
    'core.context_processors.total_translations',
)
...
WSGI_APPLICATION = 'pylyglot.wsgi.application'
